...
const VerticalNavbar4 = () => {
  return (
    <section className="h-screen bg-[#f8f6f1] dark:bg-dark">
      <div className="flex h-screen w-full max-w-[300px] flex-col justify-between overflow-y-scroll bg-gray-1 dark:bg-dark-2">
        <div>
        ...
        {/* <div className="px-6 py-10">
          <div className="flex items-center rounded-[10px] bg-white px-[18px] py-4 shadow-1 dark:bg-dark-3 dark:shadow-box-dark">
  ...
  return (
    <li className="relative">
      <a
        ...
        className={`${
          dropdownOpen ? "bg-primary text-white dark:text-white" : ""
        } group relative mb-[2px] flex items-center rounded px-4 py-[10px] text-base font-medium text-body-color duration-200 hover:bg-primary hover:text-white dark:text-dark-6`}
      >
...
const DropdownItem = ({ link, menu }) => {
  return (
    <li>
      <a
        href={link}
        className="flex items-center border-r-4 border-transparent py-[10px] text-base font-medium text-body-color duration-200 hover:text-primary dark:text-dark-6"
      >
        {menu}
      </a>
    </li>
...
const Divider = () => {
  return <div className="mx-10 my-3 h-[1px] bg-[#e7e7e7] dark:bg-dark-3"></div>;
};
